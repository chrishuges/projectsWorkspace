...
sampleTag="20210610_renataChla10AcetylIpLysnarginase"
...
fixedModifications=''
variableModifications='"Oxidation of M, Acetylation of K"'
enzyme='"LysargiNase"'

#####call the parameters file creation
callingParameters='java -cp "$searchGuiLocation" eu.isas.searchgui.cmd.IdentificationParametersCLI -out ./databaseSearchParameters.par -prec_ppm 1 -prec_tol 20 -frag_ppm 0 -frag_tol 0.05 -fixed_mods "$fixedModifications" -variable_mods "$variableModifications" -enzyme "$enzyme" -msgf_instrument 3 -msgf_protocol 5 -msgf_fragmentation 3'
...
eval "scp ${startingDirectory}/rawDataProcessing_m16k42HcdOtHumanLysarginaseIndividual.sh $PWD"
