...
```{r}
##########################################################################################
quantFiles = file.path(paste(baseRepository, '/sequencing20211210_soleMscToEwsPmid34341072/rnaSeq/quants', sep = ''), samples$accession, 'quant.sf')
...
ggplot(targetData, aes(sampleNames, tpm, color = sampleNames)) +
  ...
  labs(y = 'log2(TPM + 1)', title = 'CNMD in EWIma cells') +
...
ggsave(paste(baseRepository, '/sequencing20211210_soleMscToEwsPmid34341072/rnaSeq/scatter_cnmdRnaExpressionLevels.pdf', sep = ''),
