...
```{r}
##########################################################################################
quantFiles = file.path(paste(baseRepository, '/sequencing20201208_ewsFil1RnaSeqRiggiPmid25453903/archive', sep = ''), paste(samples$sample, '_quant', sep = ''), 'quant.sf')
...
geneExpData = read_csv(paste(baseRepository, '/sequencing20201208_ewsFil1RnaSeqRiggiPmid25453903/archive/dataset_riggiSalmonRnaSeqProcessedData.csv', sep = '')) %>%
...
for (i in 1:length(targetGenes)){
  ...
  ggplot(geneExpData, aes(a673Fc, sknmcFc)) +
    ...
    geom_text_repel(label = geneExpData$pText, max.overlaps = 10000) +
