...
This document describes the processing of some RNAseq data from A673 EwS cells treated with shRNA against RUNX3. These data are from a published paper:

Bledsoe KL, McGee-Lawrence ME, Camilleri ET, Wang X et al. RUNX3 facilitates growth of Ewing sarcoma cells. J Cell Physiol 2014 Dec;229(12):2049-56. 
PMID: 24812032, GEO: [GSE56900](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE56900)
...
Move into our working directory and create our shell and snakemake scripts.

```shell
cd /mnt/Data/chughes/projectsRepository/sorensenLab/relatedToDlg2/sequencing20220914_runx3ShrnaPmid24812032
...
workingDirectory="/mnt/Data/chughes/projectsRepository/sorensenLab/relatedToDlg2/sequencing20220914_runx3ShrnaPmid24812032"
...
for i in SRR1249341 SRR1249342
do
