...
raw = read_tsv('D:/msDataTemp/proteomics20230404_a673p1Dlg2KoRescue/report.tsv', show_col_types = FALSE) %>%
  dplyr::mutate(File.Name = sub('.*ch20230404_a673p1Dlg2KoRescue_(.*)_dia_[123]\\.mzML', '\\1', File.Name)) %>%
  dplyr::filter(Q.Value <= 0.01)

##save the data
write.table(raw, 'D:/msDataTemp/proteomics20230404_a673p1Dlg2KoRescue/reportParsed.tsv', 
            col.names = TRUE, row.names = FALSE, quote = FALSE, sep = '\t')


##run the IQ analysis
iqResult = process_long_format('D:/msDataTemp/proteomics20230404_a673p1Dlg2KoRescue/reportParsed.tsv', 
                           output_filename = 'D:/msDataTemp/proteomics20230404_a673p1Dlg2KoRescue/reportParsedIqQuant.tsv',
...
##parse the IQ result
proData = read_tsv('D:/msDataTemp/proteomics20230404_a673p1Dlg2KoRescue/reportParsedIqQuant.tsv', show_col_types = FALSE) %>%
  dplyr::rename(accession = 'Protein.Group',
                symbol = 'Genes')


##save the data
saveRDS(proData, paste(baseRepository, '/proteomics20230404_a673p1Dlg2KoRescue/dataset_processedA673p1Dlg2KoTotalProteome.rds', sep = ''))
write.table(proData, paste(baseRepository, '/proteomics20230404_a673p1Dlg2KoRescue/dataset_processedA673p1Dlg2KoTotalProteome.tsv', sep = ''), 
            col.names = TRUE, row.names = FALSE, quote = FALSE, sep = '\t')
```
...
processedData = readRDS(paste(baseRepository, '/proteomics20230404_a673p1Dlg2KoRescue/dataset_processedA673p1Dlg2KoTotalProteome.rds', sep = ''))
conditionsToCompare = c('ko8','ko11','rescue8','rescue11')
...
for (i in 1:length(conditionsToCompare)){
  ...
  forPsm = readRDS(paste(baseRepository, '/proteomics20230404_a673p1Dlg2KoRescue/dataset_processedA673p1Dlg2KoTotalProteome.rds', sep = ''))
  ...
  #
  saveRDS(deqmsResults, paste(baseRepository, '/proteomics20230404_a673p1Dlg2KoRescue/dataset_deqms_', conditionsToCompare[i], '-', controlCondition, '.rds', sep = ''))
  write.table(deqmsResults, paste(baseRepository, '/proteomics20230404_a673p1Dlg2KoRescue/dataset_deqms_', conditionsToCompare[i], '-', controlCondition, '.tsv', sep = ''),
  ...
  ggplot(plotData, aes(logFC, -log10(sca.P.Value))) +
    ...
    theme_classic()
  ggsave(paste(baseRepository, '/proteomics20230404_a673p1Dlg2KoRescue/dataset_deqms_', conditionsToCompare[i], '-', controlCondition, '.pdf', sep = ''),
