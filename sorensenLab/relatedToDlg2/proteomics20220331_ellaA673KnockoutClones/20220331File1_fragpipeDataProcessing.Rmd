...
baseRepository = 'D:/msDataTemp/proteomics20220331_ellaA673KnockoutClones'
...
```{r}
##########################################################################################
cond = as.factor(c('dmso','cr8','dmso','cr8','dmso','cr8','cr2','cr2','cr2'))
...
limmaContrasts = c('cr8 - dmso', 'cr8 - cr2', 'cr2 - dmso')
...
write.table(deqmsResults, 
            paste(baseRepository, '/dataset_deqms_cr8-dmso.csv', sep = ''),
            sep = ',', row.names = FALSE, quote = FALSE)
##
deqmsResults = outputResult(limmaFit3, coef_col = 2)
dim(deqmsResults)
write.table(deqmsResults, 
            paste(baseRepository, '/dataset_deqms_cr8-cr2.csv', sep = ''),
            sep = ',', row.names = FALSE, quote = FALSE)
##
deqmsResults = outputResult(limmaFit3, coef_col = 3)
dim(deqmsResults)
write.table(deqmsResults, 
            paste(baseRepository, '/dataset_deqms_cr2-dmso.csv', sep = ''),
            sep = ',', row.names = FALSE, quote = FALSE)
```
...
ggplot(deqmsResults, aes(logFC, plotPValue)) +
  ...
  labs(x = 'log2(cr8 - dmso)', y = '-log10(P-value)', title = 'CR8 vs. DMSO abundance') +
  scale_y_continuous(limits = c(0,12), breaks = seq(0,18,3)) +
  scale_x_continuous(limits = c(-6,6), breaks = seq(-6,6,2)) +
  geom_vline(xintercept = c(-0.5,0.5), linetype = 'dashed') +
  geom_hline(yintercept = 3, linetype = 'dashed') +
  theme_classic()
ggsave(paste(baseRepository, '/scatter_deqms_a673_cr8-dmso.pdf', sep = ''),
...
ggplot(deqmsResults, aes(logFC, plotPValue)) +
  geom_point(size = 1, color = deqmsResults$pColors, alpha = 0.5) +
  geom_text_repel(label = deqmsResults$pText, nudge_x = -2, max.overlaps = 10000) +
  labs(x = 'log2(cr8 - cr2)', y = '-log10(P-value)', title = 'CR8 vs CR2 protein abundance') +
  scale_y_continuous(limits = c(0,12), breaks = seq(0,18,3)) +
  scale_x_continuous(limits = c(-6,6), breaks = seq(-6,6,2)) +
  geom_vline(xintercept = c(-0.5,0.5), linetype = 'dashed') +
  geom_hline(yintercept = 3, linetype = 'dashed') +
  theme_classic()
ggsave(paste(baseRepository, '/scatter_deqms_a673_cr8-cr2.pdf', sep = ''),
       height = 2, width = 2, useDingbats = FALSE)
...
ggplot(deqmsResults, aes(logFC, plotPValue)) +
  geom_point(size = 1, color = deqmsResults$pColors, alpha = 0.5) +
  geom_text_repel(label = deqmsResults$pText, nudge_x = -2, max.overlaps = 10000) +
  labs(x = 'log2(cr2 - dmso)', y = '-log10(P-value)', title = 'CR2 vs DMSO protein abundance') +
  scale_y_continuous(limits = c(0,12), breaks = seq(0,18,3)) +
  scale_x_continuous(limits = c(-6,6), breaks = seq(-6,6,2)) +
  geom_vline(xintercept = c(-0.5,0.5), linetype = 'dashed') +
  geom_hline(yintercept = 3, linetype = 'dashed') +
  theme_classic()
ggsave(paste(baseRepository, '/scatter_deqms_a673_cr2-dmso.pdf', sep = ''),
       height = 2, width = 2, useDingbats = FALSE)
```
