...
This document describes the reprocessing of some RNAseq data from the [Human Protein Atlas](https://www.proteinatlas.org/). I am specifically interested in the liver data. They have deposited the raw files in ENA with the accession [ERP006650](https://www.ebi.ac.uk/ena/browser/view/PRJEB6971).
...
for i in ERR315{327,414,463,394,451}
do
