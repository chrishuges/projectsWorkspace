...
```{r}
##########################################################################################
dataIrsRaw = as.data.frame(readRDS(paste(baseRepository, '/proteomics20201220_a673ShEwsFli1DoxTimecourse/archive/dataset_proteinSetABCIrsNormalized.rds', sep = '')))
...
goi = c('IL1RAP','STEAP1','STEAP2','PRKCB','LOX')
...
ggplot(deqmsResults, aes(logFC, plotPValue)) +
  ...
  theme_classic()
ggsave(paste(baseRepository, '/proteomics20201220_a673ShEwsFli1DoxTimecourse/archive/scatter_deqmsIrsDay7-Day0.pdf', sep = ''),
       height = 2, width = 2, useDingbats = FALSE)
```
