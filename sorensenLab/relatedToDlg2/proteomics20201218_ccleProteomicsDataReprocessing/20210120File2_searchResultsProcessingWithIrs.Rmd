...
```{r}
library('vroom')
test = vroom(paste('C:/Users/chughes/Documents/bccrc/projectsRepository/sorensenLab/relatedToCcle/gygiWebsiteData/ccle_protein_quant_with_peptides_14745.tsv.gz', sep = '')) %>%
  dplyr::filter(grepl('DLG2', GeneSymbol))
