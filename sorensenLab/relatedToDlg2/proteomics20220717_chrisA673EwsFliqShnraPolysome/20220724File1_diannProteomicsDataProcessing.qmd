...
This document details the analysis of proteomics data from A673 cells treated with an shRNA against EWS-FLI1 for 7-days. The proteomic data were obtained using a DIA protocol and processed with [DiaNN software](https://github.com/vdemichev/DiaNN).
...
pepHighRaw = diann_load('D:\\msDataTemp\\proteomics20220717_chrisA673EwsFliqShnraPolysome\\highAllReplicatesNoGrouping\\report.tsv')
pepLowRaw = diann_load('D:\\msDataTemp\\proteomics20220717_chrisA673EwsFliqShnraPolysome\\lowAllReplicatesNoGrouping\\report.tsv')
...
saveRDS(allPeps, paste(baseRepository,'/proteomics20220717_chrisA673EwsFliqShnraPolysome/dataset_strippedPeptidesMaxLfqDiann.rds',sep=''))
```
...
rm(allPeps)
pepData = readRDS(paste(baseRepository,'/proteomics20220717_chrisA673EwsFliqShnraPolysome/dataset_strippedPeptidesMaxLfqDiann.rds',sep=''))
...
##save these data
saveRDS(pepData, paste(baseRepository, '/proteomics20220717_chrisA673EwsFliqShnraPolysome/dataset_rawDataProteinLevel_day7-day0.rds',sep = ''))
write.table(pepData, paste(baseRepository, '/proteomics20220717_chrisA673EwsFliqShnraPolysome/dataset_rawDataProteinLevel_day7-day0.tsv',sep = ''),
...
deqmsOutput
saveRDS(deqmsOutput, paste(baseRepository, '/proteomics20220717_chrisA673EwsFliqShnraPolysome/dataset_deqmsProteinLevel_day7-day0.rds',sep = ''))
write.table(deqmsOutput, paste(baseRepository, '/proteomics20220717_chrisA673EwsFliqShnraPolysome/dataset_deqmsProteinLevel_day7-day0.tsv',sep = ''),
            col.names = TRUE, row.names = FALSE, quote = FALSE, sep = '\t')
```
