...
#  dplyr::mutate(rnaExprs = ifelse(rnaExprs >= expQuantileHigh, 'high', 'low'))
#  dplyr::select(ovs, status, rnaExprs)
...
ggsurvplot(survivalFit,
          ...
          surv.median.line = "hv", # Specify median survival
          ggtheme = theme_classic(), # Change ggplot2 theme
          palette = c(brewer.pal(3,'Blues')[3], brewer.pal(3,'OrRd')[3]),
          title = 'DLG2 survival analysis',
          legend = 'none')
ggsave(paste(baseRepository, '/microarray20201203_dlg2PostelVinaySurvival/survival_fli1SurvivalPostelVinay.pdf', sep = ''), 
