...
##write it to a better file format for our script
sraLine = vector()
for (i in 1:length(unique(allRuns$sra))){
  sraLine = c(sraLine, allRuns$sra[i])
}
writeLines(paste(sraLine, collapse = ' '), paste(baseRepository,'/dataset_sraRunsWithPtxDataLine.txt', sep = ''))
```
