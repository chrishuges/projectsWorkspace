...
baseRepository = 'D:/msDataTemp/proteomics20220326_haifengBsdPtxTc32Set'
...
write.table(deqmsResults, 
            paste(baseRepository, '/dataset_deqms_tc32_bsd-dmso.csv', sep = ''),
            sep = ',', row.names = FALSE, quote = FALSE)
##
deqmsResults = outputResult(limmaFit3, coef_col = 2)
dim(deqmsResults)
write.table(deqmsResults, 
            paste(baseRepository, '/dataset_deqms_tc32_bsd-resc.csv', sep = ''),
            sep = ',', row.names = FALSE, quote = FALSE)
##
deqmsResults = outputResult(limmaFit3, coef_col = 3)
dim(deqmsResults)
write.table(deqmsResults, 
            paste(baseRepository, '/dataset_deqms_tc32_resc-dmso.csv', sep = ''),
            sep = ',', row.names = FALSE, quote = FALSE)
```
...
ggplot(deqmsResults, aes(logFC, plotPValue)) +
  ...
  theme_classic()
ggsave(paste(baseRepository, '/scatter_deqms_tc32_bsd-dmso.pdf', sep = ''),
...
ggplot(deqmsResults, aes(logFC, plotPValue)) +
  ...
  geom_hline(yintercept = 3, linetype = 'dashed') +
  theme_classic()
ggsave(paste(baseRepository, '/scatter_deqms_tc32_bsd-resc.pdf', sep = ''),
       height = 2, width = 2, useDingbats = FALSE)
...
ggplot(deqmsResults, aes(logFC, plotPValue)) +
  ...
  geom_hline(yintercept = 3, linetype = 'dashed') +
  theme_classic()
ggsave(paste(baseRepository, '/scatter_deqms_tc32_resc-dmso.pdf', sep = ''),
       height = 2, width = 2, useDingbats = FALSE)
```
