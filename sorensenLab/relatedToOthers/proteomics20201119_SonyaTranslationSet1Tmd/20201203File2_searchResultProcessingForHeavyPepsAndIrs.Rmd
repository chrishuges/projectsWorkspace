...
proteinSet = psmQuantFiltered[,c(3,9:14,17:19)] %>%
  rename(dmsoSet1.1 = tmt10plex_126, dmsoSet1.2 = tmt10plex_127C, dmsoSet1.3 = tmt10plex_128C, 
         isribSet1.1 = tmt10plex_127N, isribSet1.2 = tmt10plex_128N, isribSet1.3 = tmt10plex_129N,
         heavyPoolSet1.1 = tmt10plex_130C, lightPoolSet1.1 = tmt10plex_131N, heavyPoolSet1.2 = tmt10plex_131C) %>%
  group_by(accession) %>%
  summarise(across(where(is.double), list(sum = sum, med = median)))
##save data
saveRDS(proteinSet, paste(baseRepository, '/proteomics20201119_SonyaTranslationSet1Tmd/dataset_proteinSetDataset1.rds', sep = ''))
```
