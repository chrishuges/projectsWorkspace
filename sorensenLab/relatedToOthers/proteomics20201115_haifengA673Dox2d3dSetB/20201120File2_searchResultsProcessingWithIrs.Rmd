...
proteinSet = psmQuantFiltered[,c(3,8,11:16,19:20,22:23)] %>%
  rename(pool3d.1 = tmt16plex_126C,
         noDox3d.1 = tmt16plex_128N, noDox3d.2 = tmt16plex_128C, noDox3d.3 = tmt16plex_129N, 
         yesDox3d.1 = tmt16plex_129C, yesDox3d.2 = tmt16plex_130N, yesDox3d.3 = tmt16plex_130C, 
         washOut3d.1 = tmt16plex_132N, washOut3d.2 = tmt16plex_132C, washOut3d.3 = tmt16plex_133C,
         pool3d.2 = tmt16plex_134N) %>%
  group_by(accession) %>%
  summarise(across(where(is.double), list(sum = sum, med = median)))
##save data
saveRDS(proteinSet, paste(baseRepository, '/proteomics20201115_haifengA673Dox2d3dSetB/dataset_proteinSet3d.rds', sep = ''))
```
