...
This document goes through the processing used on the raw data used in the analysis indicated by the parent folder in which this file is stored.
...
sampleTag="24Jan2018_NB_Kelly_TMT6"
#this is the desired location for the output of the data processing process
desiredBaseLocation="/projects/ptx_results/2018/Fusion/01-Jan/Samples/SC/"
#this is the base location where your raw data is stored
dataStorageLocation="/projects/ptx_results/2018/Fusion/01-Jan/Samples/SC/"
...
fixedModifications='"TMT 6-plex of peptide N-term"'
variableModifications='"Oxidation of M, TMT 6-plex of K"'
