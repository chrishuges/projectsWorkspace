...
saveRDS(quantInput, paste(baseRepository, '/proteomics20201119_SonyaTranslationSet2Tmd/dataset_peptideQuantDataPreDEqMS.rds', sep = ''))
...
write.table(deqmsResults, 
            paste(baseRepository, '/proteomics20201119_SonyaTranslationSet2Tmd/dataset_deqms_3h_isrib-dmso.csv', sep = ''),
...
ggplot(deqmsResults, aes(logFC, plotPValue)) +
  ...
  labs(x = 'log2(yesDox - noDox)', y = '-log10(P-value)', title = '3h hypoxia protein abundance') +
  #scale_y_continuous(limits = c(0,12), breaks = seq(0,18,3)) +
  #scale_x_continuous(limits = c(-6,6), breaks = seq(-6,6,2)) +
  geom_vline(xintercept = c(-0.5,0.5), linetype = 'dashed') +
  geom_hline(yintercept = 3, linetype = 'dashed') +
  theme_classic()
ggsave(paste(baseRepository, '/proteomics20201119_SonyaTranslationSet2Tmd/scatter_deqms_3h_isrib-dmso.pdf', sep = ''),
