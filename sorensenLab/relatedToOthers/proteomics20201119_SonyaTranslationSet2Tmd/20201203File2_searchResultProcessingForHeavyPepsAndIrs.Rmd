...
proteinSet = psmQuantFiltered[,c(3,9:14,17:19)] %>%
  rename(dmsoSet2.1 = tmt10plex_126, dmsoSet2.2 = tmt10plex_127C, dmsoSet2.3 = tmt10plex_128C, 
         isribSet2.1 = tmt10plex_127N, isribSet2.2 = tmt10plex_128N, isribSet2.3 = tmt10plex_129N,
         heavyPoolSet2.1 = tmt10plex_130C, lightPoolSet2.1 = tmt10plex_131N, heavyPoolSet2.2 = tmt10plex_131C) %>%
  group_by(accession) %>%
  summarise(across(where(is.double), list(sum = sum, med = median)))
##save data
saveRDS(proteinSet, paste(baseRepository, '/proteomics20201119_SonyaTranslationSet2Tmd/dataset_proteinSetDataset2.rds', sep = ''))
```
