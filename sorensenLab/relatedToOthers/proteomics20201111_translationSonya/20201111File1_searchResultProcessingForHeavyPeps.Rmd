...
```{r}
##########################################################################################
proteinAnnotation = readRDS(paste(baseRepository, '/proteomics20201111_translationSonya/uniprotHumanNov2020.fasta.annotated.rds', sep = ''))
```
...
```{r}
##########################################################################################
psm = read_tsv(paste(baseRepository, '/proteomics20201111_translationSonya/20201106_SonyaTranslationSet1Tmd_silac10R8K-TMT10_HpH_Default_PSM_Report.txt', sep = '')) %>%
...
```{r, message = FALSE, warning = FALSE}
##########################################################################################
quantFiles = as.list(list.files(paste(baseRepository, '/proteomics20201111_translationSonya/quantFiles/', sep = ''),
