...
This document describes the processing of some RNAseq data from A673 cells purified against an endogenous expressed version of YBX1 with a HiBit tag.
...
```shell
find /mnt/Data/chughes/projectsRepository/sorensenLab/relatedToYbx1/sequencing20221011_ybx1HibitRip/raw -type f -name "*.fastq.gz" -exec mv {} /mnt/Data/chughes/projectsRepository/sorensenLab/relatedToYbx1/sequencing20221011_ybx1HibitRip/fastq \;
```
...
```shell
cd /mnt/Data/chughes/projectsRepository/sorensenLab/relatedToYbx1/sequencing20221011_ybx1HibitRip
...
workingDirectory="/mnt/Data/chughes/projectsRepository/sorensenLab/relatedToYbx1/sequencing20221011_ybx1HibitRip"
...
for i in F117335 F117336 F117337 
do
