...
```{r}
source(paste(baseWorkspace, '/20200529_explorationYbx1DepMap/userDefinedFunctions.R', sep = ''))
```
...
#
ggplot(crispr_yb1_lineage, aes(reorder(lineage, `YBX1 (4904)`, FUN = median), `YBX1 (4904)`, group = lineage, color = lineage)) +
...
ggsave(paste(baseWorkspace, '/20200529_explorationYbx1DepMap/scatterplot_ybx1CeresScoresLineages.pdf', sep = ''),
       useDingbats = FALSE,
       height = 4, 
       width = 4)
```
