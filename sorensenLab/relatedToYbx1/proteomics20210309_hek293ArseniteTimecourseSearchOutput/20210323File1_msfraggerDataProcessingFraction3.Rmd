---
title: "Aresenite polysome proteomics"
output:
  html_notebook:
      code_folding: none
---

This document details the analysis of proteomics data acquired for comparison of polysome proteomes in arsenite stress. 
...
```{r, message = FALSE}
##########################################################################################
samplePrefix = c('cytoEdta','cytoTime0','cytoTime30','cytoTime60','cytoTime120','cytoTime240')
...
saveRDS(peptideSet, 
        paste(baseRepository, '/proteomics20210309_hek293ArseniteTimecourseSearchOutput/fraction3/dataset_allPeptideData.rds', sep = ''))
...
write.table(plotData, paste(baseRepository, '/proteomics20210309_hek293ArseniteTimecourseSearchOutput/fraction3/dataset_deqmsAnalysis_edta-time0.tsv', sep = ''),
...
ggplot(plotData, aes(logFCScaled, logPValueScaled)) +
  ...
  theme_classic()
##
ggsave(paste(baseRepository, '/proteomics20210309_hek293ArseniteTimecourseSearchOutput/fraction3/scatter_deqmsAnalysis_edta-time0.pdf', sep = ''),
