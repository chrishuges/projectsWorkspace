...
raw = read_tsv('D:/msDataTemp/proteomics20230410_a673p1Ybx1HibitTotalProteome/report.tsv', show_col_types = FALSE) %>%
  dplyr::mutate(File.Name = sub('.*ch20230410_a673p1Ybx1Hibit_totalProteome_(.*)_dia_[123]\\.mzML', '\\1', File.Name)) %>%
  dplyr::filter(Q.Value <= 0.01)

##save the data
write.table(raw, 'D:/msDataTemp/proteomics20230410_a673p1Ybx1HibitTotalProteome/reportParsed.tsv', 
            col.names = TRUE, row.names = FALSE, quote = FALSE, sep = '\t')


##run the IQ analysis
iqResult = process_long_format('D:/msDataTemp/proteomics20230410_a673p1Ybx1HibitTotalProteome/reportParsed.tsv', 
                           output_filename = 'D:/msDataTemp/proteomics20230410_a673p1Ybx1HibitTotalProteome/reportParsedIqQuant.tsv',
...
##parse the IQ result
proData = read_tsv('D:/msDataTemp/proteomics20230410_a673p1Ybx1HibitTotalProteome/reportParsedIqQuant.tsv', show_col_types = FALSE) %>%
  dplyr::rename(accession = 'Protein.Group',
                symbol = 'Genes')


##save the data
saveRDS(proData, paste(baseRepository, '/proteomics20230410_a673p1Ybx1HibitTotalProteome/dataset_processedA673p1Ybx1HibitTotalProteome.rds', sep = ''))
write.table(proData, paste(baseRepository, '/proteomics20230410_a673p1Ybx1HibitTotalProteome/dataset_processedA673p1Ybx1HibitTotalProteome.tsv', sep = ''), 
            col.names = TRUE, row.names = FALSE, quote = FALSE, sep = '\t')
```
...
processedData = readRDS(paste(baseRepository, '/proteomics20230410_a673p1Ybx1HibitTotalProteome/dataset_processedA673p1Ybx1HibitTotalProteome.rds', sep = ''))
...
for (i in 1:length(conditionsToCompare)){
  ...
  forPsm = readRDS(paste(baseRepository, '/proteomics20230410_a673p1Ybx1HibitTotalProteome/dataset_processedA673p1Ybx1HibitTotalProteome.rds', sep = ''))
  ...
  #
  saveRDS(deqmsResults, paste(baseRepository, '/proteomics20230410_a673p1Ybx1HibitTotalProteome/dataset_deqms_', conditionsToCompare[i], '-', controlCondition, '.rds', sep = ''))
  write.table(deqmsResults, paste(baseRepository, '/proteomics20230410_a673p1Ybx1HibitTotalProteome/dataset_deqms_', conditionsToCompare[i], '-', controlCondition, '.tsv', sep = ''),
  ...
  ggplot(plotData, aes(logFC, -log10(sca.P.Value))) +
    ...
    theme_classic()
  ggsave(paste(baseRepository, '/proteomics20230410_a673p1Ybx1HibitTotalProteome/dataset_deqms_', conditionsToCompare[i], '-', controlCondition, '.pdf', sep = ''),
