...
```{r}
##########################################################################################
mqData = read_tsv(paste(baseRepository, '/20200527_explorationPolysomeProteomicsPublished/MaxQuantOutput/proteinGroups.txt', sep = ''))
problems(mqData)
```
...
##save the data
saveRDS(mqDataParsed, paste(baseRepository, '/20200527_explorationPolysomeProteomicsPublished/dataset_silacRatiosPolysomeParsed.rds', sep = ''))
```
...
ggsave(paste(baseWorkspace, '/20200527_explorationPolysomeProteomicsPublished/lineplot_ribosomeSubunitAbundanceReplicates.pdf', sep = ''),
       useDingbats = FALSE,
       height = 4,
       width = 4)
```
