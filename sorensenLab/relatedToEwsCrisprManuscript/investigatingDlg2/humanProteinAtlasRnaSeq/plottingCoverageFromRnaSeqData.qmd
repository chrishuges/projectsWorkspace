---
title: "Normal tissue RNA coverage"
...
This document describes investigating RNAseq results to see what the coverage of DLG2 transcripts looks like. I am using the human protein atlas RNAseq data for this.
...
ggsave(paste(baseRepository, '/investigatingDlg2/humanProteinAtlasRnaSeq/plots/coverage_dlg2CoverageBrainTissue.pdf', sep = ''),
         height = 2, width = 2, useDingbats = FALSE)
```

Now we want to plot the coverage of the long isoform in the skin samples.
...
plotCoverage(dlg2Exons, dlg2Cds, 
             ...
             heights = c(2,1), fill_palette = getGenotypePalette(),
             rescale_introns = TRUE)
ggsave(paste(baseRepository, '/investigatingDlg2/humanProteinAtlasRnaSeq/plots/coverage_dlg2CoverageSkinTissue.pdf', sep = ''),
         height = 2, width = 2, useDingbats = FALSE)
```
