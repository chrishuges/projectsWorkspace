...
This document describes processing of proteomics data from an experiment to look at A673p1 cells with KO of DLG2.
...
##save the data
saveRDS(proData, paste(baseRepository, '/investigatingDlg2/sorensenDlg2A673p1KoProteomics/datasetOutputs/dataset_processedMbrA673p1Dlg2KoTotalProteome.rds', sep = ''))
write.table(proData, paste(baseRepository, '/investigatingDlg2/sorensenDlg2A673p1KoProteomics/datasetOutputs/dataset_processedMbrA673p1Dlg2KoTotalProteome.tsv', sep = ''), 
            col.names = TRUE, row.names = FALSE, quote = FALSE, sep = '\t')
```
...
processedData = readRDS(paste(baseRepository, '/investigatingDlg2/sorensenDlg2A673p1KoProteomics/datasetOutputs/dataset_processedMbrA673p1Dlg2KoTotalProteome.rds', sep = ''))
...
for (i in 1:length(conditionsToCompare)){
  ...
  forPsm = readRDS(paste(baseRepository, '/investigatingDlg2/sorensenDlg2A673p1KoProteomics/datasetOutputs/dataset_processedMbrA673p1Dlg2KoTotalProteome.rds', sep = ''))
  ...
  #
  saveRDS(deqmsResults, paste(baseRepository, '/investigatingDlg2/sorensenDlg2A673p1KoProteomics/datasetOutputs/dataset_deqmsMbr_', conditionsToCompare[i], '-', controlCondition, '.rds', sep = ''))
  write.table(deqmsResults, paste(baseRepository, '/investigatingDlg2/sorensenDlg2A673p1KoProteomics/datasetOutputs/dataset_deqmsMbr_', conditionsToCompare[i], '-', controlCondition, '.tsv', sep = ''),
  ...
  ggplot(plotData, aes(logFC, -log10(sca.P.Value))) +
    ...
    theme_classic()
  ggsave(paste(baseRepository, '/investigatingDlg2/sorensenDlg2A673p1KoProteomics/plots/scatter_deqmsMbr_', conditionsToCompare[i], '-', controlCondition, '.pdf', sep = ''),
...
genesOfInterest = c('DLG2','STEAP1','BLVRA','STEAP2','HMOX1','NOS1','LY96')
expData = ko11
