...
dlg2Peaks = read_tsv(paste(baseRepository, '/investigatingDlg2/aynaudChipSeq/macsOutput/SRR8832674_peaks.xls', sep = ''), 
...
day0Peaks = read_tsv(paste(baseRepository, '/investigatingDlg2/aynaudChipSeq/macsOutput/SRR8832667_peaks.xls', sep = ''), 
                     skip = 30, show_col_types = FALSE,
...
superE = read_tsv(paste(baseRepository, '/investigatingDlg2/aynaudChipSeq/rose/roseDay0/SRR8832667_chr11Peaks_SuperEnhancers.table.txt', sep = ''), 
...
ggsave(paste(baseRepository, '/investigatingDlg2/aynaudChipSeq/rose/roseDay0/lineplot_dlg2AllDatasetPeaks.pdf', sep = ''),
...
```{r}
##########################################################################################
superDay0 = read_tsv(paste(baseRepository, '/investigatingDlg2/aynaudChipSeq/rose/roseDay0/SRR8832667_chr11Peaks_SuperEnhancers.table.txt', sep = ''), 
                     skip = 5)
#
superDay7 = read_tsv(paste(baseRepository, '/investigatingDlg2/aynaudChipSeq/rose/roseDay7/SRR8832668_chr11Peaks_SuperEnhancers.table.txt', sep = ''), 
                     skip = 5)
...
ggsave(paste(baseRepository, '/investigatingDlg2/aynaudChipSeq/rose/roseDay0/barplot_dlg2DatasetSeCounts.pdf', sep = ''),
         height = 2, width = 2, useDingbats = FALSE)
```
