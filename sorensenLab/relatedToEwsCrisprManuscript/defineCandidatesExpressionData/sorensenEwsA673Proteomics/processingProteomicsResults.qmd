...
for (i in 1:length(toCompare)){
  ...
  dataIrs = dataIrsRaw[,c(which(grepl(datasetFirst, colnames(dataIrsRaw)) | grepl(datasetSecond, colnames(dataIrsRaw))))] #I only keep the two time points I want to compare here
