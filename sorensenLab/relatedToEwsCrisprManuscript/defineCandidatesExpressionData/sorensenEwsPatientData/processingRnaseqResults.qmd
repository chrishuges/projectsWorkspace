...
test = geneExpData[,c('FLI1','EWSR1','UGT3A2','DLG2','YBX1','IL1RAP','LOX','NGFR','HMOX1','NOS1','POU3F1')]
cor(test)
```
...
##save these data
saveRDS(geneExpData, paste(baseRepository, '/defineCandidatesExpressionData/sorensenEwsPatientData/datasetOutputs/dataset_tpmExpression.rds', sep = ''))
write.table(geneExpData, paste(baseRepository, '/defineCandidatesExpressionData/sorensenEwsPatientData/datasetOutputs/dataset_tpmExpression.tsv', sep = ''), 
...
##test plot
plotInput = corInput[,c('DLG2','GLG1')]
ggplot(plotInput, aes(log2(DLG2+1), log2(GLG1+1))) +
  geom_point()
```
