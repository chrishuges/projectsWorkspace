...
In the above file, there end up being some repeats of msat's because of overlapping gene regions. The next thing we want to do is to overlap the GGAA data with our RNA expression hits. 
...
I want to add a column to the RNA data indicating whether there is a GGAA site in proximity to the gene.
