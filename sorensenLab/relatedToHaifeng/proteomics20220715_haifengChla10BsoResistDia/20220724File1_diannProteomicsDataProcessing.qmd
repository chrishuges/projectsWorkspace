...
pepHighRaw = diann_load('D:\\msDataTemp\\proteomics20220715_haifengChla10BsoResistDia\\highMassAllReplicatesNoGroup\\report.tsv')
pepLowRaw = diann_load('D:\\msDataTemp\\proteomics20220715_haifengChla10BsoResistDia\\lowMassAllReplicatesNoGroup\\report.tsv')
...
saveRDS(allPeps, paste(baseRepository,'/proteomics20220715_haifengChla10BsoResistDia/dataset_strippedPeptidesMaxLfqDiann.rds',sep=''))
```
...
rm(allPeps)
pepData = readRDS(paste(baseRepository,'/proteomics20220715_haifengChla10BsoResistDia/dataset_strippedPeptidesMaxLfqDiann.rds',sep=''))
...
##save these data
saveRDS(pepData, paste(baseRepository, '/proteomics20220715_haifengChla10BsoResistDia/dataset_rawDataProteinLevel_bsd-dmso.rds',sep = ''))
write.table(pepData, paste(baseRepository, '/proteomics20220715_haifengChla10BsoResistDia/dataset_rawDataProteinLevel_bsd-dmso.tsv',sep = ''),
...
deqmsOutput
saveRDS(deqmsOutput, paste(baseRepository, '/proteomics20220715_haifengChla10BsoResistDia/dataset_deqmsProteinLevel_bsd-dmso.rds',sep = ''))
write.table(deqmsOutput, paste(baseRepository, '/proteomics20220715_haifengChla10BsoResistDia/dataset_deqmsProteinLevel_bsd-dmso.tsv',sep = ''),
            col.names = TRUE, row.names = FALSE, quote = FALSE, sep = '\t')
```
