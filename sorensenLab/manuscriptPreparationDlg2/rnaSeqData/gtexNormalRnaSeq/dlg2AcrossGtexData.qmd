...
ggsave(paste(baseRepository, '/rnaSeqData/gtexNormalRnaSeq/plots/boxplot_dlg2RnaExpressionSmtsGtex.pdf', sep = ''),
...
ggsave(paste(baseRepository, '/rnaSeqData/gtexNormalRnaSeq/plots/boxplot_dlg2RnaExpressionSmtsGtexSubset.pdf', sep = ''),
       height = 2, width = 2, useDingbats = FALSE)
```
